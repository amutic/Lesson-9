...
Due on 3/22 at 5 pm.
```{r}
path <- "C:/Users/AHENDE8/Documents/R class- big data/N741MachineLearning- Lecture9/Lesson-9/MiSeq_SOP"
fns <- list.files(path)
fns
```

my github repository can be found at [https://github.com/amutic/Lesson-9](https://github.com/amutic/Lesson-9)